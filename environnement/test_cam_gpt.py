...
class Game:
    def __init__(self):
        ...
        self.camera_offset = 0  # Décalage de la caméra
        self.camera_speed = 2  # Vitesse du mouvement de la caméra
    ...
    def update_camera(self):
        ...
        self.camera_offset += self.camera_speed
        if self.camera_offset > max(plateforme.rect.x for plateforme in self.plateformes):  # Arrêter si la caméra a tout défilé
            self.camera_offset = max(plateforme.rect.x for plateforme in self.plateformes)
    ...
    def run(self):
        ...
        while self.isRunning:
            ...
            # Dessiner les éléments avec le décalage de caméra
            self.draw_elements()
